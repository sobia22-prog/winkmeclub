    ...
    <header className="h-16 bg-brand-surface/90 backdrop-blur-md border-b border-brand-border sticky top-0 z-40 px-4 md:px-8 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        {wallet && !isAdmin && (
          <Link
            to="/wallet"
            className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-brand-card border border-brand-border rounded-xl text-xs font-semibold hover:border-slate-600 transition-all"
          >
