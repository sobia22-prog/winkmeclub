    ...
    try {
      ...
      return res.status(200).json({
        ...
        user: {
          ...
          allowWithdraw: req.user.allowWithdraw ?? true,
          allowTrade: req.user.allowTrade ?? true,
          creditScore: req.user.creditScore ?? 100,
          hasTransactionPin: Boolean(req.user.transactionPinHash),
