...
const seedData = async () => {
  try {
    ...
    // 7. Seed Sample Recharge Requests (Pending & Processed)
    await RechargeRequest.create([
      {
        ...
        referenceNumber: 'UPI-982138129045',
      ...
      },
      {
        ...
        referenceNumber: 'IMPS-7788112233',
        receiptUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=500&auto=format&fit=crop&q=80',
        status: 'PENDING',
      ...
      },
      {
        ...
        referenceNumber: 'PTM-6655443322',
        receiptUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=500&auto=format&fit=crop&q=80',
        status: 'APPROVED',
        processedBy: admin._id,
      ...
      },
      {
        ...
        referenceNumber: 'GPY-1122334455',
        status: 'REJECTED',
        rejectionReason: 'Payment reference UTR mismatched with bank statement',
        processedBy: admin._id,
    ...
    // 7.1 Seed Sample Withdrawal Requests (Pending & Processed)
    await WithdrawalRequest.create([
      {
        ...
        bankName: 'HDFC Bank',
        accountHolder: 'Client John',
        accountNumber: '987654321012',
        ifscCode: 'HDFC0001234',
        upiId: 'client@hdfcbank',
        status: 'PENDING',
      ...
      },
      {
        ...
        status: 'REJECTED',
        rejectionReason: 'Invalid IFSC code supplied by client',
        processedBy: admin._id,
